                ...
                <div class="container">
                    <div class="col-sm-12" style="text-align: left;" aria-multiline="True">
                        ...
                        <div style="text-align: center;" id="ModifyButtonDIV">
                            ...
                            <br />
                            <asp:Button ID="btnWantModify" runat="server" class="btn btn-info" Text="更新入数路径及文件名等信息" Style="margin: 10px;" />
                            <asp:Button ID="btnConfirmModify" runat="server" class="btn btn-success" Text="确定更新入数路径及文件名等信息" Style="margin: 10px;" Enabled="false" />
