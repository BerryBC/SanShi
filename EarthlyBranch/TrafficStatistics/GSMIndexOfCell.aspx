<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GSMIndexOfCell.aspx.vb" Inherits="TrafficStatistics_GSMIndexOfCell" %>
<%----第14号页面--%>
                ...
                <div class="container">
                    <div class="col-sm-12" style="text-align: left;" aria-multiline="True">
                        ...
                        <div class="wow bounceInLeft" data-wow-delay="0.1s" style="text-align: left;">
                            <h2 style="border-bottom-style: groove;">GSM网格每日指标 ( Daily KPI of GSM )</h2>
                        </div>
                        ...
                        <div style="text-align: center;" id="ModifyButtonDIV">
                            ...
                            <br />
                            <asp:Button ID="btnWantModify" runat="server" class="btn btn-info" Text="开始更新入数路径及文件名信息" Style="margin: 10px;" />
                            <asp:Button ID="btnConfirmModify" runat="server" class="btn btn-success" Text="确定更新入数路径及文件名信息" Style="margin: 10px;" Enabled="false" />
