<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RenewGCellListWithChineseName.aspx.vb" Inherits="ThisLife_RenewTheGuaranteeCellList_RenewGCellListWithChineseName" %>
<%----第21号页面--%>
            ...
            <section style="padding-bottom: 20px;">
                <div class="container">
                    ...
                    <div class="col-sm-12 alert alert-info" style="text-align: center; text-align: left;">
                            ...
                            1、请下载模板，并根据模板格式上传保障小区列表：<a href="./Files/TemplateFiles/TemplateFromChineseName.xlsx">模板下载</a>，并保证表头标紫列不为空。</br></br>
