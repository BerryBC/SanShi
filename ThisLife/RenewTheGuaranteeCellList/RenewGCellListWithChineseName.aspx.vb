Imports System.Data
Imports System
Partial Class ThisLife_RenewTheGuaranteeCellList_RenewGCellListWithChineseName
    ...
    Private Sub btnGo_Click(sender As Object, e As EventArgs) Handles btnGo.Click
        ...
        Catch ex As Exception
            If Session("SanShiUserName") Is Nothing Then
                erlErrorReport.ReportServerError(21, "", ex.Message, Now)
                Response.Redirect("/ReportErrorLog.aspx?ep=21&eu=" & "")
            Else
                erlErrorReport.ReportServerError(21, Session("SanShiUserName"), ex.Message, Now)
                Response.Redirect("/ReportErrorLog.aspx?ep=21&eu=" & Session("SanShiUserName"))
    ...
    Private Sub ThisLife_RenewTheGuaranteeCellList_RenewGCellListWithChineseName_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub bwGetEnterWorker_DoWork(ByRef progress As Integer, ByRef _result As Object, ByRef OutputTheTmp As String, ByVal ParamArray arguments As Object())
        ...
        Try
            ...
            If fuFileA.HasFile Then
                ...
                RenewGCellListLibrary.UpdateCellsRowsByChineseName(Session("SanShiUserName"), strGuaranteeName)
