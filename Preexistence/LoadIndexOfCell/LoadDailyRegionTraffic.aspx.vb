...
Partial Class Preexistence_LoadIndexOfCell_LoadDailyRegionTraffic
    ...
    Private Sub SaveIndexFile(strSQLS As String)
        ...
        Try
            ...
            strSaveFileName = Now.ToString("yyyyMMddHHmmss") & "-区域天总业务量导出表-" & Session("SanShiUserName") & ".csv"
        ...
        Catch ex As Exception
            If Session("SanShiUserName") Is Nothing Then
                erlErrorReport.ReportServerError(37, "", ex.Message, Now)
                Response.Redirect("/ReportErrorLog.aspx?ep=37&eu=" & "")
            Else
                erlErrorReport.ReportServerError(37, Session("SanShiUserName"), ex.Message, Now)
                Response.Redirect("/ReportErrorLog.aspx?ep=37&eu=" & Session("SanShiUserName"))
    ...
    Private Sub Preexistence_LoadIndexOfCell_LoadDailyRegionTraffic_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub timerGo_Tick(sender As Object, e As EventArgs) Handles timerGo.Tick
        ...
        Try
            ...
            End If
            strSQLSHandel += " group by Day,网格九分区"
