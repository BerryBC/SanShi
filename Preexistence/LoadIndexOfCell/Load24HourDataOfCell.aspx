<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Load24HourDataOfCell.aspx.vb" Inherits="Preexistence_LoadIndexOfCell_Load24HourDataOfCell" %>
<%----第45号页面--%>
                ...
                <div class="container">
                    <div class="col-sm-12" style="text-align: left;" aria-multiline="True">
                        <div class="wow bounceInLeft" data-wow-delay="0.1s" style="text-align: left;">
                            <h2 style="border-bottom-style: groove;">批量导出GSM小区级小时级业务量 ( Batch Export GSM Cell Hour Data )</h2>
                        </div>
                    </div>
                        ...
                        <tr style="text-align: center; align-items: center;">
                            ...
                            <td>
                                <asp:Panel ID="plFromDateToDate" runat="server" Visible="false">
                                    ...
                                    <asp:DropDownList ID="ddlWhatTimeBegin" runat="server"  AutoPostBack="True">
                                ...
                                <asp:ListItem Text="21" Value="21" ></asp:ListItem>
                                <asp:ListItem Text="22" Value="22" ></asp:ListItem>
                                <asp:ListItem Text="23" Value="23"  Selected="True" ></asp:ListItem>
                                    </asp:DropDownList>&nbsp 时
                                </asp:Panel>
                            </td>
                        </tr>
